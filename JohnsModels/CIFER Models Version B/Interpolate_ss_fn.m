...
%Use minreal for pole/zero cancellation. This is likely caused by the gust
%vane dynamics. There's probably a better way to do this but it works.
sys_actuation = minreal(ss(A_actuation,B_actuation,C_actuation,D_actuation),[],false);
