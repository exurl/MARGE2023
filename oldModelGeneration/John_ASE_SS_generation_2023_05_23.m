...
%
AirDeNSity=1.293 ;% kg/m^3 %     < -------------------------------AirDeNSity
rho=AirDeNSity;
%
...
%
DynPressLow = .5*AirDeNSity*(10^2); % < --------------------------------------------------------------qDLow

DynPressHigh = .5*AirDeNSity*(30^2); % < -------------------------------------------------------------qDHigh
