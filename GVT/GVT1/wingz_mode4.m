...
w = [30,80]; % <-- FREQUENCY BANDWIDTH FOR CZT FRF
...
for idx_file = 1:N_files-2 % ignore 2020z and 2024z hammer tests
    for idx_sensor = 1:N_sensors(idx_file) % ignore no sensors
